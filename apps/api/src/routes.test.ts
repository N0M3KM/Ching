...
describe('content routes',()=>{
 it.each(['/healthz','/api/v1/tracks','/api/v1/lessons/beginner-01','/api/v1/dictionary?query=water','/api/v1/pinyin?text=你好','/api/v1/sentences?level=advanced&tag=register'])('GET %s',async path=>{
